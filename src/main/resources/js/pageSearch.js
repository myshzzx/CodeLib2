...
// http://www.zhangxinxu.com/study/js/jquery.textSearch-1.0.js
...
function search(text) {
	$("body").textSearch(text, {markStyle: "background-color: yellow;", nullReport: false});
}
